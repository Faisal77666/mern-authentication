 ...
 useEffect(()=>{
  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <h1 className='text-white text-center font-semibold text-2xl mb-4 '>Email Verify OTP</h1>
      ...
      <button  className='w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3'>Verify Email</button>
     </form>
